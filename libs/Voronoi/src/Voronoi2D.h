...
#include "../lib/cell_2d.h"
#include "../lib/v_base_2d.h"
#include "../lib/rad_option.h"
#include "../lib/container_2d.h"
#include "../lib/v_compute_2d.h"
#include "../lib/c_loops_2d.h"
#include "../lib/wall_2d.h"
#include "../lib/cell_nc_2d.h"
#include "../lib/ctr_boundary_2d.h"
#include "ofMain.h"
...
inline void Voronoi2D::clear() {
    ...
    if(curr) con = new voro::container_2d(curr->ax, curr->bx, curr->ay, curr->by, curr->nx, curr->ny, false, false, curr->ps);
    delete curr;
}
